...
import CarosuelComponent from "./Caroseal";
...
const hotelData = [
  ...
  {
    userId: "678f0f29cd0990a7b6d36d73",
    name: "The Coastal View Inn",
    city: "San Diego",
    country: "USA",
    description:
...
const weekendDeals = [
  {
    ...
    description:
      "Enjoy a 3-night stay at a discounted price in the heart of the mountains.",
    price: 900,
    originalPrice: 1200,
    imageUrl:
      "https://res.cloudinary.com/doozndhqq/image/upload/v1738213548/hotelBooking/yhk49wvgqiby0u7cculo.jpg",
  },
  {
    ...
    description:
      "Relax by the beach with a special weekend offer for a luxurious stay.",
    price: 750,
    originalPrice: 1000,
    imageUrl:
      "https://res.cloudinary.com/doozndhqq/image/upload/v1738213548/hotelBooking/ys2wodklysitrvevkx7p.jpg",
  ...
  {
    name: "City Lights Getaway",
    description:
      "Experience the vibrant nightlife and attractions in the city's heart with our exclusive offer.",
    price: 600,
    originalPrice: 850,
    imageUrl:
      "https://res.cloudinary.com/doozndhqq/image/upload/v1738213548/hotelBooking/yhk49wvgqiby0u7cculo.jpg",
  },
  {
    ...
    description:
      "Relax in the serene countryside with a 4-night package at a discounted price.",
    price: 650,
    originalPrice: 850,
    imageUrl:
      "https://res.cloudinary.com/doozndhqq/image/upload/v1738213548/hotelBooking/yhk49wvgqiby0u7cculo.jpg",
  },
  {
    ...
    description: "Indulge in luxury with a 5-star island resort offer.",
    price: 1200,
    originalPrice: 1500,
    imageUrl:
      "https://res.cloudinary.com/doozndhqq/image/upload/v1738213548/hotelBooking/yhk49wvgqiby0u7cculo.jpg",
    ...
    <div className="p-4 sm:p-6 space-y-8 font-sans">
      ...
      <header className="text-center space-y-4">
        ...
        <p className="text-base sm:text-lg">
          Find your perfect getaway from beachside relaxation to thrilling ski
          resorts.
        </p>
      </header>
          ...
          <div className="mt-4">
            ...
            <div className="mt-4">
              <button className="bg-blue-500 text-white px-4 py-2 rounded-md">
                Book Now at ${featuredHotel.pricePerNight}/night
              </button>
            </div>
          </div>
        </div>
      ...
      <section>
        ...
        <CarosuelComponent data={visitedAreas} />
      </section>
      ...
      <section>
        ...
        <CarosuelComponent data={weekendDeals} />
      </section>
